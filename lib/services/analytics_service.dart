...
class AnalyticsService {
  ...
  Future<PeriodComparison> getPeriodComparison(
    ...
    try {
      ...
      final currentData = await _fetchPeriodData(
        userId,
        currentStart,
        currentEnd,
      );
      ...
      final previousData = await _fetchPeriodData(
        userId,
        previousStart,
        previousEnd,
      );
      ...
      // Calculate metrics
      final moodChange =
          (currentData.avgMood ?? 0) - (previousData.avgMood ?? 0);
      final entriesChange =
          currentData.entriesCount - previousData.entriesCount;
      final consistencyChange =
          currentData.consistencyScore - previousData.consistencyScore;
      final selfCareChange =
          currentData.selfCareRate - previousData.selfCareRate;
  ...
  Future<PeriodData> _fetchPeriodData(
    ...
    final habitsResponse = <Map<String, dynamic>>[]; // Return empty list
